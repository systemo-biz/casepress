...
class PersonPage {
    ...
    function __construct() {
    	...
    	add_action('cp_entry_content_after', array($this, 'add_datatable_to_page_person'), 9 );
    ...
    function ckpp_ajax_get_dossier_datatable() {
		...
		if ( ( isset( $_POST['meta'] ) && $_POST['meta'] ) && ( isset( $_POST['tax'] ) && $_POST['tax'] ) ) {
			// Define params
			$params = array(
				'fields' => 'ID:link, post_title:link, prioritet, organization, post_date, functions:tax',
