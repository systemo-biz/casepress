...
//				);
            $ctmeta_datable_params['fields'] = 'ID:link, post_title:link, member_from-cp-posts-sql:post, responsible-cp-posts-sql:post, cp_date_deadline:date, results:tax, functions:tax';
