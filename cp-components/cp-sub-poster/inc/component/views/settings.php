<div id="cp-component-settings" class="wrap">
	<div id="icon-options-general" class="icon32 hide-if-no-js"><br /></div>
	<h2 id="cp-component-tabs" class="nav-tab-wrapper hide-if-no-js">
		<?php
			// Show tabs
			$this->render_tabs();
		?>
	...
	?>
	<form action="<?php echo $this->admin_url; ?>" method="post" id="cp-component-options-form">
		<?php
			// Show options
			$this->render_panes();
		?>
