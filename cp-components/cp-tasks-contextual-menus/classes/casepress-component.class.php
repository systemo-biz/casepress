<?php
	...
	if ( !class_exists( 'CasePress_Component' ) ) {
		...
		class CasePress_Component {
			 ...
			 */
			function CasePress_Component( $file, $base = 'casepress/cp-components' ) {
...
//				plugins_url( '', $this->file );
				...
				// Add component initialization hook
			...
			/*	echo $this->url;
				echo '</br>';
				echo plugins_url().'/'.$this->base.'/'.$this->slug;
				echo '</br>';
				*/
			}
			...
			//	echo '1111111111111111111111111111111145451';
			//	
