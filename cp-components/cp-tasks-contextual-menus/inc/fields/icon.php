...
<tr<?php echo $triggable; ?>>
	...
	<td>
		<div class="gndev-plugin-icon-picker">
			<input type="text" value="<?php echo $settings[$option['id']]; ?>" name="<?php echo $option['id']; ?>" id="gndev-plugin-field-<?php echo $option['id']; ?>" class="regular-text gndev-plugin-icon-picker-value gndev-plugin-prevent-clickout" style="width:270px" />
			<img src="<?php echo $settings[$option['id']]; ?>" alt="<?php _e( 'Preview', $this->textdomain ); ?>" class="gndev-plugin-icon-picker-preview" data-id="<?php echo $option['id']; ?>" />
